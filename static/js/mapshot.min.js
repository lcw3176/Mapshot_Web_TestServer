...
var KakaoTile = /*#__PURE__*/function () {
  function KakaoTile() {
  ...
  _createClass(KakaoTile, [{
    ...
    key: "drawGet",
    value: function drawGet(proxyUrl, onSuccess) {
    ...
    key: "drawPost",
    value: function drawPost(proxyUrl, jsonData, onSuccess) {
      var kakaoTileOnProgressEvent = new CustomEvent("kakaoTileOnProgress", {
        detail: {
          percentage: 0
        }
...
var NaverTile = /*#__PURE__*/function () {
  function NaverTile() {
