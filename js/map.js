...
var Map = /*#__PURE__*/function () {
  ...
  _createClass(Map, [{
    ...
    key: "searchAddrFromCoords",
    value: function searchAddrFromCoords(coords, callback) {
      // 좌표로 행정동 주소 정보를 요청합니다
      this.geocoder.coord2RegionCode(coords.getLng(), coords.getLat(), callback);
    }
  }, {
    key: "searchDetailAddrFromCoords",
    value: function searchDetailAddrFromCoords(coords, callback) {
      // 좌표로 법정동 상세 주소 정보를 요청합니다
      this.geocoder.coord2Address(coords.getLng(), coords.getLat(), callback);
    }
  }, {
    key: "displayCenterInfo",
    value: function displayCenterInfo() {}
  }, {
    key: "setLatLngText",
    value: function setLatLngText() {
    ...
    key: "getRectangleBounds",
    value: function getRectangleBounds() {
    ...
    key: "placesSearchCB",
    value: function placesSearchCB(data, status, pagination) {
      if (status === kakao.maps.services.Status.OK) {
    ...
    value: function displayPlaces(places) {
      ...
      var _loop = function _loop() {
        ...
        var marker = _this.addMarker(placePosition, i);

        var itemEl = _this.getListItem(i, places[i]); // 검색 결과 항목 Element를 생성합니다
    ...
    key: "getListItem",
    value: function getListItem(index, places) {
    ...
    key: "addMarker",
    value: function addMarker(position, idx, title) {
    ...
    value: function displayPagination(pagination) {
    ...
    value: function displayInfowindow(marker, title) {
      var content = '<div style="padding:5px;z-index:1;">' + title + '</div>';
      infowindow.setContent(content);
      infowindow.open(map, marker);
    }
  }, {
    key: "removeAllChildNods",
    value: function removeAllChildNods(el) {
